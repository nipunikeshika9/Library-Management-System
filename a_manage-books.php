...
if(isset($_GET['del'])){
    $delete_id = $_GET['del'];
    $delete_image_query = mysqli_query($conn, "SELECT bookImage FROM `tblbooks` WHERE id = '$delete_id'") or die('query failed');
    $fetch_delete_image = mysqli_fetch_assoc($delete_image_query);
    unlink('uploaded_img/'.$fetch_delete_image['bookImage']);
    mysqli_query($conn, "DELETE FROM `tblbooks` WHERE id = '$delete_id'") or die('query failed');
    $_SESSION['delmsg']="Book Deleted Sucessfully.";
    header('location:a_manage-books.php');
 }
